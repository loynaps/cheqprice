 ...
 */
public class SupermarketAdmin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supermarket_admin);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(SupermarketAdmin.this,
    ...
    private void Login(final String email, final String password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Config.URL_SUP_USER, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(!error){
                        ...
                        Toast.makeText(SupermarketAdmin.this,"Successfully login",Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(SupermarketAdmin.this, SupermarketAdminProducts.class);
                        ...
                        Toast.makeText(SupermarketAdmin.this,"Error in login",Toast.LENGTH_SHORT).show();
                    }
