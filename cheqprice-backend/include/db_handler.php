<?php /** * Class to handle all db operations * This class will have CRUD methods for database tables *  class DbHandler { private $conn; function __construct() { require_once dirname(__FILE__) . '/DbConnect.php'; // opening db connection $db = new DbConnect(); $this->conn = $db->connect();
 }
 ...
 */
 ...
 $actualpath = "http://192.168.1.100/supermarket_api/$path";
 ...
 */
 ...
 if($page_id<=$page_limit){ //Calculating start for every given page number 
